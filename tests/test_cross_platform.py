...
""")
    ...
    @pytest.mark.skipif(not IS_WINDOWS, reason="Windows shell test")
...
class TestPlatformEdgeCases:
    ...
    def test_windows_long_path(self):
        ...
        try:
            ...
            if "too long" in error_str or "206" in str(e):
...
class TestShellIntegration:
    ...
    @pytest.mark.skipif(not IS_WINDOWS, reason="PowerShell script test")
